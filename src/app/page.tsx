...
/* ΓöÇΓöÇ Interactive Innovation Launch Engine (Hero Right Animation) ΓöÇΓöÇ */
      ...
      <div className="relative z-10">
        ...
        {submitted ? (
          <motion.div initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="text-emerald-600 font-bold text-sm bg-emerald-50 py-3.5 px-6 rounded-2xl border border-emerald-100">
            ≡ƒÄë Thank you! You've successfully subscribed to our newsletter.
          </motion.div>
        ) : (
...
export default function Home() {
  ...
  const stats = [
    ...
    { value: "Γé╣5 Lakh", label: "NAIN Project Funding", icon: Award, color: "#7c3aed" },
    { value: "Γé╣2.5 Lakh", label: "Launchpad MVP Grant", icon: Zap, color: "#1a56db" },
  ...
  const directors = [
    ...
    { name: "Dr. Prasad Rampure", role: "Registrar, VTU ΓÇö Board of Directors", img: "/images/registrar.webp" },
    { name: "Dr. Ujwal Urubail", role: "Registrar (Evaluation), VTU ΓÇö Board of Directors", img: "/images/ujwal.webp" },
  ];
  ...
  const tbiTeam = [
    ...
    { name: "Vikas Rudrapur", role: "Associate ΓÇô Events & Programs", img: "/images/vikas.webp", linkedin: "https://www.linkedin.com/in/vikas-rudrapur-4b3516235/" },
    ...
    { name: "Chetan Gaonkar", role: "Associate ΓÇô Media & Marketing", img: "/images/chetan.webp", linkedin: "https://www.linkedin.com/in/chetan-gaonkar-7b9958214/" },
    { name: "Anju Jamboti", role: "Associate ΓÇô Admin", img: "/images/anju.webp", linkedin: "https://www.linkedin.com/in/anju-jamboti-059b16224/" },
  ];
  ...
  const marqueeItems = [
    "≡ƒÜÇ Startup Incubation", "ΓÜí Innovation Programs", "≡ƒö¼ Research Commercialization",
    "≡ƒÆí Entrepreneurship Development", "≡ƒñ¥ Industry Partnerships", "≡ƒÅå NAIN PMU",
    "≡ƒæ⌐ΓÇì≡ƒÆ╝ Women Innovators", "≡ƒ¢╕ Drone Technology", "≡ƒñû Robotics Lab", "≡ƒôí IoT Centre",
    "≡ƒû¿∩╕Å 3D Prototyping", "≡ƒîÉ VTU Belagavi", "Γ£¿ TBI Navodaya",
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen relative" style={{ background: "#f0f4ff", color: "#0d1b3e" }}>
      ...
      {/* ΓòÉΓòÉΓòÉ FIXED VRIF LOGO BACKGROUND ΓÇö large, visible, static ΓòÉΓòÉΓòÉ */}
            ...
            >
              {activeTab === "overview" && (
                <>
                  ...
                  {/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ ABOUT ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
                      ...
                      <ScrollFloat3D>
                        <div>
                          ...
                          <p className="text-base text-slate-600 leading-relaxed mb-8">
                            VRIF fosters a culture of innovation, entrepreneurship, and research commercialization across Karnataka&apos;s engineering ecosystem ΓÇö spanning 210+ VTU-affiliated colleges and over 5,000 students.
                          </p>
              ...
              {activeTab === "contact" && (
                <>
                    ...
                    <div className="max-w-xl mx-auto">
                      <motion.div whileHover={{ y: -6 }}
                        ...
                        <div>
                          ...
                          <p className="text-sm text-slate-500 leading-relaxed">Official brochure ΓÇö programs, infrastructure, team, and impact across Karnataka.</p>
                        </div>
                  ...
                  {/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ SUBSCRIBE ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
                  ...
                  {/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ CONTACT ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
                  <section id="contact" className="py-16 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                      {[
                        ...
                        { icon: Phone, title: "Phone", content: "+91 97394 44818\nMonΓÇôFri, 9 AM ΓÇô 6 PM IST", color: "#10b981", action: "tel:9739444818", glowClass: "hover-glow-green" },
                      ].map((card, i) => {
                  ...
                  {/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ FOOTER ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-12 px-6">
                      <div className="md:col-span-5 flex flex-col gap-5">
                        ...
                        <p className="text-slate-500 text-sm leading-relaxed max-w-sm">
                          Visvesvaraya Research & Innovation Foundation (VRIF) ΓÇö the innovation and entrepreneurship arm of VTU, Belagavi.
                        </p>
                      ...
                      <div className="md:col-span-4 flex flex-col gap-4">
                        ...
                        <p className="text-slate-500 text-sm leading-relaxed">
                          ...
                          Belagavi ΓÇô 590018, Karnataka, India
                        </p>
                      </div>
                    </div>
