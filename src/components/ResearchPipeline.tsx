  ...
  return (
    <div className="w-full py-12">
      <div className="text-center mb-12">
        <span className="inline-flex items-center gap-2 text-[10px] font-extrabold uppercase tracking-widest text-cyan-300 bg-cyan-500/10 border border-cyan-500/20 px-3 py-1 rounded-full mb-3">
          Commercialization Protocol
        </span>
        <h3 className="text-2xl md:text-4xl font-black text-slate-100 tracking-tight">
          From Academic Lab to <span className="text-gradient-blue">Global Market</span>
        </h3>
        <p className="text-slate-400 font-medium text-sm max-w-xl mx-auto mt-2">
